                    ...
                    <td colspan="4">
                        <table border="0" width="100%"">
                            <tr>
                                <td width="50%">
                                    <center>
                                        <p class="heading-main12" style="margin: 0;font-size:20px;padding: 10px;color:rgb(49, 49, 49);font-weight:600;text-align: left;">Up Coming Sessions</p>
                                ...
                                <td width="50%" style="padding: 0;">
                                    ...
                                    <p class="heading-main12" style="margin: 0;font-size:20px;padding: 10px;color:rgb(49, 49, 49);font-weight:600;text-align: left;">Your Recent Bookings</p>
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $sqlmain= "select * from appointment inner join schedule on schedule.scheduleid=appointment.scheduleid inner join patient on patient.pid=appointment.pid inner join doctor on schedule.docid=doctor.docid where patient.pid=$userid and schedule.scheduledate>='$today' order by schedule.scheduledate asc"; 
                                            $result= $database->query($sqlmain);
