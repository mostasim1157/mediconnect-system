        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td>
                        <p style="font-size: 23px;padding-left:12px;font-weight: 600;">My Bookings</p>
                   ...
                   <td colspan="4">
                       <center>
                        ...
                        <tbody>
                            ...
                            <?php
                                $sqlmain = "SELECT * FROM appointment INNER JOIN doctor ON appointment.docid = doctor.docid WHERE pid = ? ORDER BY appodate DESC";
                                $stmt = $database->prepare($sqlmain);
                                ...
                                if($result->num_rows==0){
                                    ...
                                    <a class="non-style-link" href="doctors.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Book New Appointment &nbsp;</font></button>
                                    </a>
                                    </center>
                                    <br><br><br><br>
                                    </td>
                                    ...
                                    while($row=$result->fetch_assoc()){
                                        ...
                                        echo '<tr>
                                            ...
                                            <a href="?action=drop&id='.$appoid.'" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-delete"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Cancel</font></button></a>
                                            </div>
                                            </td>
                                        </tr>';
                                    }
