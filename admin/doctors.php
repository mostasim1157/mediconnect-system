        ...
        if($action=='drop'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <a href="doctors.php" class="non-style-link"><button  class="btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"><font class="tn-in-text">&nbsp;&nbsp;No&nbsp;&nbsp;</font></button></a>
            ...
            ';
                ...
                $errorlist= array(
                    ...
                    '4'=>"",
                    '5'=>'<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;">An error occurred during registration. Please try again.</label>',
                    '0'=>'',
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="nid" class="input-text" placeholder="NID Number" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="url" class="input-text" placeholder="Paste Your URL" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="nid" class="input-text" placeholder="NID Number" value="'.$nid.'" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="url" class="input-text" placeholder="Paste Your URL" value="'.$url.'" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
...
1.  **Replace the files** with the code provided above.
2.  **Clear the ghost account:** Go into your `webuser` table in the database and **manually delete the row** for the doctor you tried to add previously (the one that failed). This will allow you to add them again successfully with the new, fixed code.

After these changes, the bug should be completely resolv