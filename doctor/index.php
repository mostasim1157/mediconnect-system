                ...
                <tr>
                    ...
                    <tr>
                        <td >
                            ...
                            You can view your appointment requests and manage them from here.<br><br>
                            </p>
                    ...
                    <td colspan="4">
                        <table border="0" width="100%"">
                            <tr>
                                    ...
                                    <center>
                                        <table class="filter-container" style="border: none;" border="0">
                                            ...
                                            <?php
                                                ...
                                                $newbooking = $database->query("select * from appointment where docid=$userid and status=0;");
                                                $totalbooking = $database->query("select * from appointment where docid=$userid;");
                                            ?>
                                            <tr>
                                                <td style="width: 25%;">
                                            ...
                                            <tr>
                                                <td style="width: 25%;">
                                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex; ">
                                                        <div>
                                                                <div class="h1-dashboard" ><?php echo $newbooking->num_rows ?></div><br>
                                                                <div class="h3-dashboard" >New Requests &nbsp;&nbsp;</div>
                                                        </div>
                                                ...
                                                <td style="width: 25%;">
                                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex;padding-top:21px;padding-bottom:21px;">
                                                        <div>
                                                                <div class="h1-dashboard"><?php echo $totalbooking->num_rows ?></div><br>
                                                                <div class="h3-dashboard" style="font-size: 15px">Total Appointments</div>
                                                        </div>
                                ...
                                <td>
                                    <p id="anim" style="font-size: 20px;font-weight:600;padding-left: 40px;">Your Upcoming Appointments until Next week</p>
                                    <center>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $sqlmain= "SELECT patient.pname, appointment.appodate, appointment.appotime FROM appointment INNER JOIN patient ON patient.pid=appointment.pid WHERE appointment.docid=$userid AND appointment.status=1 AND appointment.appodate BETWEEN '$today' AND '$nextweek' ORDER BY appointment.appodate, appointment.appotime ASC"; 
                                                ...
                                                if($result->num_rows==0){
                                                    ...
                                                    while($row=$result->fetch_assoc()){
                                                        ...
                                                        echo '<tr>
                                                            <td style="text-align:center; padding: 10px;">'.substr($pname,0,30).'</td>
